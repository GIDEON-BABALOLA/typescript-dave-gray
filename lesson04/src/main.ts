//Assertions is telling the compiler that you know more about the types so it needs to listen to you because you 
//have a little bit of detail to what the typescript may infer
type One = string
...
let d = <One>"world" //Dosen't work in tsx
...
const nextImg = <HTMLImageElement>document.getElementById("#img") // Remember that this does in react tsx files
img.src
myImg.src
